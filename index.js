...
form.addEventListener('submit', function(event) {
    ...
    axios.post("https://expense-tracker-2o39.onrender.com/user/add-user", userDetails,{headers:{"Authorization" : token}})
    .then((res) => {
      console.log(res);
...
let lastPage = 1;
  ...
  async function loadPage(month, year, page) {
    ...
    try {
      const response = await axios.get(`https://expense-tracker-2o39.onrender.com/user/get-expenses/${month}/${year}/${rows}?page=${page}`, {
...
async function handleYearChange() {
  ...
  try {
    const response = await axios.get(`https://expense-tracker-2o39.onrender.com/user/get-expenses/${year}`,{headers:{"Authorization" : token}});
...
async function handleDateChange() {
  ...
  try {
    const token= localStorage.getItem('token');
    const response = await axios.get(`https://expense-tracker-2o39.onrender.com/user/get-expense/${day}/${month}/${year}`,{headers:{"Authorization" : token}});
...
document.getElementById('rzp-button1').onclick = async function (e) {
  ...
  try {
      ...
      const token = localStorage.getItem('token');
      console.log(token);
      const response = await axios.get(`https://expense-tracker-2o39.onrender.com/purchase/premiummembership`, {headers: { "Authorization": token }});
      ...
      var options = {
          ...
          "handler": async function (response) {
              try {
                  await axios.post(`https://expense-tracker-2o39.onrender.com/purchase/updatetransactionstatus`, {
...
async function isPremium() {
  ...
  const token = localStorage.getItem('token');
  const response = await axios.get(`https://expense-tracker-2o39.onrender.com/purchase/isPremium`, {headers: { "Authorization": token }});
...
async function leaderboard() {
  ...
  const token = localStorage.getItem('token');
  const response = await axios.get(`https://expense-tracker-2o39.onrender.com/purchase/leaderboard`, {headers: { "Authorization": token }});
...
async function handleDownload() {
  const token = localStorage.getItem('token');
  const response = await axios.get(`https://expense-tracker-2o39.onrender.com/download`, {headers: { "Authorization": token }});
